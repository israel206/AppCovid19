    ...
    <div className="app">
      <div className="app__left">
        ...
        <div className="app__stats">
          <InfoBox title='Casos de coronavírus' cases={countryInfo.todayCases} total={countryInfo.cases} type='cases' changeCasesType={changeCasesType} />
          <InfoBox title='Recuperados' cases={countryInfo.todayRecovered} total={countryInfo.recovered} type='recovered' changeCasesType={changeCasesType} />
          <InfoBox title='Mortes' cases={countryInfo.todayDeaths} total={countryInfo.deaths} type='deaths' changeCasesType={changeCasesType} />
        </div>
